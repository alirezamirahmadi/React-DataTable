...
import { ContextType, DataTableType, filterType, ColumnType } from "../Type/Type";
...
export default function DataTable({ direction = 'ltr', columns, rows, options }: DataTableType) {
