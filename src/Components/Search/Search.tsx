...
export default function Search(): React.JSX.Element {
  ...
  return (
    <>
      <div data-testid='rdt-search' className='rdtsearch' style={{ color: mainContext.options?.color?.color, backgroundColor: mainContext.options?.color?.backgroundColor, borderColor: mainContext.options?.color?.borderColor }}>
